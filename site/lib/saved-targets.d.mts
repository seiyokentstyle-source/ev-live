...
export type TargetDefinition = {
  ...
  rate: '46/52' | '50/50'; stopRule: 'evlive';
};
...
export type PublishedTarget = MachineSavedTarget & {
  ...
  machine: string; profile: string; conditions: string; stopping: string; rate: '46/52' | '50/50'; updatedAt: string; assumedPayout?: boolean;
};
...
export function selectSavedTargets(catalog: SavedTargetCatalog, machineId: string, hallId: string, refreshed?: MachineSavedTarget[], replaySource?: string | null): DisplayTarget[];
export function savedTargetReplaySource(machine: unknown, hallId: string): string | null | undefined;
